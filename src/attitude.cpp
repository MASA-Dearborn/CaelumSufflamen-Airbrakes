...
DESIGN CHANGE
  This file replaces the earlier learned-gravity-vector method. The older method
  estimated apparent vertical direction under quasi-static conditions. This file
  implements the validated estimator kernel: gyro integrates angular motion,
...
FAILURE BEHAVIOR
  No failure path exists. This function only publishes already-maintained private
  state.
