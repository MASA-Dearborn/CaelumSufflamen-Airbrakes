...
ENGINEERING INTENT
  This file concentrates hardware feature switches, scheduler periods, telemetry
  cadence, estimator tuning, Madgwick tuning, barometer calibration constants,
  SD logging cadence, and actuator safety gates.
...
API CONSISTENCY NOTE
  This final migrated branch uses:
    RuntimeConfig
    SystemState
    AttitudeSample
    KfAlt2State
  ...
  Older branch names such as Config, EepromBlob, FlightState, AuxVertLinAccel,
  and KalmanAlt2 are intentionally absent from the public API.
===============================================================================
*/
