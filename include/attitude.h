...
===============================================================================
ROLE
  Madgwick IMU attitude estimator and quaternion-based vertical acceleration API.
...
IMPLEMENTATION MATCH
  This header intentionally exposes the Madgwick-generation functions used by
  estimation.cpp:
    attitude_begin(...)
    attitude_reset(...)
    attitude_update_imu(...)
