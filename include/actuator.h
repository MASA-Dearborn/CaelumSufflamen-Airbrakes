...
IMPLEMENTATION MATCH
  The verified actuator.cpp stores ActuatorConfig, maps normalized commands to an
  equivalent servo command, exposes the last equivalent pulse width, and always
